...
<body>
    ...
    <div class=" bg-orange-200 shadow-md fixed z-10 w-full">
        <div class="container flex mx-auto justify-between py-4 items-center font-semibold text-orange-950 text-lg">
            ...
            <div class="flex gap-x-20 items-center">
                ...
                <a href="#Chaufa" class="hover:text-orange-700 transition-colors">Chaufa</a>
                <a href="#Sopa" class="hover:text-orange-700 transition-colors">Sopa</a>
                <a href="#Especial" class="hover:text-orange-700 transition-colors">Especial</a>
                <?php
                if ($dirty == 0) {
                    ?>
    ...
    <div class="bg-orange-100 pt-28" id="Chaufa">
        ...
        <div class="container mx-auto">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <?php
                    $vecChaufa = $obj->mostrarProductosCategoria('chaufa');
                    foreach ($vecChaufa as $key) {
                        ?>
                        <div class="swiper-slide flex justify-center">
                            <div class="bg-white rounded-xl items-center flex flex-col gap-y-1 pb-5 w-72">
                                <div class="w-72">
                                    <img src="images/<?= $key[0] ?>.png" class="h-full w-full">
                                </div>
                                <h1 class="font-cascadia font-bold text-xl"><?= $key[1] ?></h1>
                                ...
                                <div class="flex text-center w-full justify-center gap-x-6 items-center">
                                    <p class="text-orange-500 font-semibold text-lg">S/<?= $key[2] ?></p>
                                    <a class="rounded-full bg-orange-500 p-1 hover:bg-orange-800 transition-colors"
                                        href="<?php if ($dirty == 1) {
                                            echo "agregarCarrito.php?id=$key[0]";
                                        } else {
                                            echo "login.php";
                                        } ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2.5" stroke="white" class="w-5 h-5">
    ...
    <div class="bg-orange-100 pt-28" id="Sopa">
        <div class="container flex flex-col items-center mx-auto">
            <div class="pb-14">
                <h1 class="text-4xl font-semibold tracking-tight">
                    Platos de sopas
        ...
        <div class="container mx-auto">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <?php
                    $vecChaufa = $obj->mostrarProductosCategoria('sopa');
                    foreach ($vecChaufa as $key) {
                        ?>
                        <div class="swiper-slide flex justify-center">
                            <div class="bg-white rounded-xl items-center flex flex-col gap-y-1 pb-5 w-72">
    ...
    <div class="bg-orange-100 pt-28 pb-28" id="Especial">
        <div class="container flex flex-col items-center mx-auto">
            <div class="pb-14">
                <h1 class="text-4xl font-semibold tracking-tight">
                    Platos Especiales
        ...
        <div class="container mx-auto">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <?php
                    $vecChaufa = $obj->mostrarProductosCategoria('especial');
                    foreach ($vecChaufa as $key) {
                        ?>
                        <div class="swiper-slide flex justify-center">
                            <div class="bg-white rounded-xl items-center flex flex-col gap-y-1 pb-5 w-72">
                                ...
                                <h1 class="font-cascadia font-bold text-xl text-center"><?= $key[1] ?></h1>
                                <p class="text-sm text-gray-400 pb-2 tracking-tighter">Plato peruano</p>
                                <div class="flex text-center w-full justify-center gap-x-6 items-center">
                                    <p class="text-orange-500 font-semibold text-lg">S/<?= $key[2] ?></p>
                                    <a class="rounded-full bg-orange-500 p-1 hover:bg-orange-800 transition-colors"
    ...
    <div class="bg-pry-dark-brown text-white pt-20 pb-10">
        <div class="container flex m-auto justify-around">
            <!--Main Menu-->
            <div>
